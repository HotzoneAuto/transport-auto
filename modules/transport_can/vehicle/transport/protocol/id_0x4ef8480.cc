...
void Id0x4ef8480::set_p_vehiclesteerpumpreadysts(
    uint8_t* data, bool vehiclesteerpumpreadysts) {
...
Id0x4ef8480* Id0x4ef8480::set_steerenablecmd(bool steerenablecmd) {
...
void Id0x4ef8480::set_p_steerenablecmd(uint8_t* data, bool steerenablecmd) {
...
Id0x4ef8480* Id0x4ef8480::set_steeranglespeedcmd(double steeranglespeedcmd) {
...
void Id0x4ef8480::set_p_steeranglespeedcmd(uint8_t* data,
  ...
  steeranglespeedcmd =
      ProtocolData::BoundedValue(0.0, 500.0, steeranglespeedcmd);
...
Id0x4ef8480* Id0x4ef8480::set_steeranglecmd(double steeranglecmd) {
  steeranglecmd_ = steeranglecmd;
  return this;
}

// config detail: {'name': 'SteerAngleCmd', 'offset': -3276.7, 'precision': 0.1,
// 'len': 16, 'is_signed_var': True, 'physical_range': '[-880|880]', 'bit': 16,
// 'type': 'double', 'order': 'intel', 'physical_unit': ''}
void Id0x4ef8480::set_p_steeranglecmd(uint8_t* data, double steeranglecmd) {
...
Id0x4ef8480* Id0x4ef8480::set_lifecnt(int lifecnt) {
  lifecnt_ = lifecnt;
  return this;
}

// config detail: {'name': 'LifeCnt', 'offset': 0.0, 'precision': 1.0, 'len': 8,
// 'is_signed_var': False, 'physical_range': '[0|255]', 'bit': 56, 'type':
// 'int', 'order': 'intel', 'physical_unit': ''}
void Id0x4ef8480::set_p_lifecnt(uint8_t* data, int lifecnt) {
...
Id0x4ef8480* Id0x4ef8480::set_currentvehiclespeed(double currentvehiclespeed) {
...
// '[0|250.99]', 'bit': 32, 'type': 'double', 'order': 'intel', 'physical_unit':
// ''}
void Id0x4ef8480::set_p_currentvehiclespeed(uint8_t* data,
                                            double currentvehiclespeed) {
  currentvehiclespeed =
      ProtocolData::BoundedValue(0.0, 250.99, currentvehiclespeed);
