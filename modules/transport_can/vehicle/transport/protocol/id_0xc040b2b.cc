...
Id0xc040b2b* Id0xc040b2b::set_xbr1_vehaccreqmode(
    int xbr1_vehaccreqmode) {
  xbr1_vehaccreqmode_ = xbr1_vehaccreqmode;
  return this;
 }

// config detail: {'name': 'XBR1_VehAccReqMode', 'offset': 0.0, 'precision': 1.0, 'len': 4, 'is_signed_var': False, 'physical_range': '[0|2]', 'bit': 8, 'type': 'int', 'order': 'intel', 'physical_unit': ''}
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_vehaccreq(
    double xbr1_vehaccreq) {
  xbr1_vehaccreq_ = xbr1_vehaccreq;
  return this;
 }

// config detail: {'name': 'XBR1_VehAccReq', 'offset': -15.0, 'precision': 0.1, 'len': 8, 'is_signed_var': True, 'physical_range': '[-15|15]', 'bit': 16, 'type': 'double', 'order': 'intel', 'physical_unit': ''}
void Id0xc040b2b::set_p_xbr1_vehaccreq(uint8_t* data,
    double xbr1_vehaccreq) {
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_clupedalreqflag(
    bool xbr1_clupedalreqflag) {
  xbr1_clupedalreqflag_ = xbr1_clupedalreqflag;
  return this;
 }

// config detail: {'name': 'XBR1_CluPedalReqFlag', 'offset': 0.0, 'precision': 1.0, 'len': 1, 'is_signed_var': False, 'physical_range': '[0|1]', 'bit': 14, 'type': 'bool', 'order': 'intel', 'physical_unit': ''}
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_clupedalopenreq(
    int xbr1_clupedalopenreq) {
  xbr1_clupedalopenreq_ = xbr1_clupedalopenreq;
  return this;
 }

// config detail: {'name': 'XBR1_CluPedalOpenReq', 'offset': 0.0, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'physical_range': '[0|255]', 'bit': 48, 'type': 'int', 'order': 'intel', 'physical_unit': ''}
void Id0xc040b2b::set_p_xbr1_clupedalopenreq(uint8_t* data,
    int xbr1_clupedalopenreq) {
  xbr1_clupedalopenreq = ProtocolData::BoundedValue(0, 255, xbr1_clupedalopenreq);
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_brkpedalreqflag(
    bool xbr1_brkpedalreqflag) {
  xbr1_brkpedalreqflag_ = xbr1_brkpedalreqflag;
  return this;
 }

// config detail: {'name': 'XBR1_BrkPedalReqFlag', 'offset': 0.0, 'precision': 1.0, 'len': 1, 'is_signed_var': False, 'physical_range': '[0|1]', 'bit': 13, 'type': 'bool', 'order': 'intel', 'physical_unit': ''}
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_brkpedalopenreq(
    int xbr1_brkpedalopenreq) {
  xbr1_brkpedalopenreq_ = xbr1_brkpedalopenreq;
  return this;
 }

// config detail: {'name': 'XBR1_BrkPedalOpenReq', 'offset': 0.0, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'physical_range': '[0|255]', 'bit': 40, 'type': 'int', 'order': 'intel', 'physical_unit': ''}
void Id0xc040b2b::set_p_xbr1_brkpedalopenreq(uint8_t* data,
    int xbr1_brkpedalopenreq) {
  xbr1_brkpedalopenreq = ProtocolData::BoundedValue(0, 255, xbr1_brkpedalopenreq);
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_accpedalreqflag(
    bool xbr1_accpedalreqflag) {
  xbr1_accpedalreqflag_ = xbr1_accpedalreqflag;
  return this;
 }

// config detail: {'name': 'XBR1_AccPedalReqFlag', 'offset': 0.0, 'precision': 1.0, 'len': 1, 'is_signed_var': False, 'physical_range': '[0|1]', 'bit': 12, 'type': 'bool', 'order': 'intel', 'physical_unit': ''}
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_accpedalopenreq(
    int xbr1_accpedalopenreq) {
  xbr1_accpedalopenreq_ = xbr1_accpedalopenreq;
  return this;
 }

// config detail: {'name': 'XBR1_AccPedalOpenReq', 'offset': 0.0, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'physical_range': '[0|255]', 'bit': 32, 'type': 'int', 'order': 'intel', 'physical_unit': ''}
void Id0xc040b2b::set_p_xbr1_accpedalopenreq(uint8_t* data,
    int xbr1_accpedalopenreq) {
  xbr1_accpedalopenreq = ProtocolData::BoundedValue(0, 255, xbr1_accpedalopenreq);
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_rollingcnt(
    int xbr1_rollingcnt) {
  xbr1_rollingcnt_ = xbr1_rollingcnt;
  return this;
 }

// config detail: {'name': 'XBR1_RollingCnt', 'offset': 0.0, 'precision': 1.0, 'len': 4, 'is_signed_var': False, 'physical_range': '[0|15]', 'bit': 4, 'type': 'int', 'order': 'intel', 'physical_unit': ''}
void Id0xc040b2b::set_p_xbr1_rollingcnt(uint8_t* data,
    int xbr1_rollingcnt) {
...
Id0xc040b2b* Id0xc040b2b::set_xbr1_sysctrlmode(
    int xbr1_sysctrlmode) {
  xbr1_sysctrlmode_ = xbr1_sysctrlmode;
  return this;
 }

// config detail: {'name': 'XBR1_SysCtrlMode', 'offset': 0.0, 'precision': 1.0, 'len': 4, 'is_signed_var': False, 'physical_range': '[0|3]', 'bit': 0, 'type': 'int', 'order': 'intel', 'physical_unit': ''}
void Id0xc040b2b::set_p_xbr1_sysctrlmode(uint8_t* data,
    int xbr1_sysctrlmode) {
